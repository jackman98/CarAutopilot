...
{
public:
    static unsigned getNext() {return Counter::GetInstance().getNext(getTypeName<T>());}
    static unsigned getCurrent() {return Counter::GetInstance().getCurrent(getTypeName<T>());}
};

class MessageCounter
{
public:
    static unsigned getNext(std::shared_ptr<IV2XMessage> msg) {return Counter::GetInstance().getNext(getTypeName(msg));}
    static unsigned getCurrent(std::shared_ptr<IV2XMessage> msg) {return Counter::GetInstance().getCurrent(getTypeName(msg));}
};
